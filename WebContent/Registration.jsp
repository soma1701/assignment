...
<body class="body">
  ...
  <form action="RequestController" name="login" method="get" onsubmit= "return validate()">
	...
	<div class="form-group">
		  ...
		  <input type="text" id="fullname" class="form-control" name="mobileNumber" placeholder="Enter your mobile number">
	</div>
	<div class="form-group">
